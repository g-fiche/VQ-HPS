"""Adapted from FastMetro (https://github.com/postech-ami/FastMETRO/blob/main/src/utils/renderer_pyrender.py)"""
...
class PyRender_Renderer:
    def __init__(
        self, resolution=(224, 224), faces=None, orig_img=False, wireframe=False
    ):
        ...
        self.scene = pyrender.Scene(
            bg_color=[0.0, 0.0, 0.0, 0.0], ambient_light=(0.05, 0.05, 0.05)
        )
...
def visualize_reconstruction_multi_view_pyrender(
    ...
    combined = np.hstack(
        [img, rend_img, img_side0, img_side1, img_side2, img_side3, img_side4]
    )
